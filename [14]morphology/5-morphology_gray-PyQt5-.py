...
form_class = uic.loadUiType('C:\\Users\\PresentJay\\Desktop\\ai_ml_vision\\AI-ImageProcessing-Training\\ui\\{}.ui'.format("window"))[0]
...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.roi = cv.imread('C:\\Users\\PresentJay\\Desktop\\ai_ml_vision\\AI-ImageProcessing-Training\\img\\{}.{}'.format("gray_img", "jpg"))
    ...
    def btn1_clicked(self):
        ...
        self.roi_gray = self.new_img.copy()
